...
def truncate_feature():
    for segment in segments:
        ...
        for sample in samples:
            ...
            feature["subj_type"] = sample["subj_type"].lower().lower()
            feature["obj_type"] = sample["obj_type"].lower().lower()
...
def figure_classes():
    with open("test-truncate.json", "r", encoding="utf-8") as f:
        samples = json.loads(f.read())
    subj_classes = {}
    obj_classes = {}
    relation_classes = {}
